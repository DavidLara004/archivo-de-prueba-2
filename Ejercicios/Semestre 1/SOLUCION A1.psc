Algoritmo sin_titulo
	...
	Para i<-1 Hasta numniñas Con Paso 1 Hacer
		...
		Si peso>=35 y peso<=50 y edad<10 Entonces
			Escribir "La niña cumple con los parametros establecidos. Su estatura es: " estatura
		SiNo
	...
	i=1
	Dimension lista[i]
	Para i<-1 Hasta totalniñas Con Paso 1 Hacer
		...
		Fin Si
	Fin Para
	Para i<-1 Hasta totalniños Con Paso 1 Hacer
